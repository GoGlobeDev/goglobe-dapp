// const GOG = artifacts.require("./GOG.sol");
// const AssertJump = require("./assert_jump.js");
//
// contract('GOG', async (accounts) => {
//
//   const TOKEN_NAME = 'GoGlobe Token';
//   const TOKEN_SYMBOL = 'GOG';
//   const TOTAL_SUPPLY = 10000000000000000;
//   const DECIMALS = 6;
//
//   it("should token deployed correctly", async () => {
//     const _token = await GOG.deployed();
//     // totalSupply
